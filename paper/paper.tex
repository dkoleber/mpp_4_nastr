...
\begin{abstract}
    ...
    In this paper, a architecture-agnostic, surrogate-model-less approach is explored as an accelerator for
    evolutionary-strategy-based neural architeure search, experimentally achieving
    acceleration of 8x while also providing benefits to exploration of the search space.
\end{abstract}
